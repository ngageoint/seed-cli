...
func PrintUnpublishUsage() {
	...
	util.PrintUtil("\nExample: \tseed unpublish -in example-0.1.3-seed:0.1.3 -r hub.docker.com -o geoint\n")
	util.PrintUtil("\nThis will remove the tag 1.0.0 for the repository example-0.2.0-seed and from hub.docker.com/geoint\n")
	return
}
